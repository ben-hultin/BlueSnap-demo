<?php
   ...
   $firstName = $_REQUEST['first_name'];   		 // typically already established during registration on the Vendor's Web Site
   $lastName = $_REQUEST['last_name'];     		 // typically already established during registration on the Vendor's Web Site
   $email = $_REQUEST['email'];      // typically already established during registration on the Vendor's Web Site

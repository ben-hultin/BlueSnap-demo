<div class="header_container">
		...
		<input type="submit" id="submit" onclick="openWindow('order-history.php', 1025)" value="Retrieve the Shopper's Order History" class="header_button" />
	...
	function openWindow(url, width)
	{
		...
		$('#iframe_window').empty();
		$('#iframe_window').append('<iframe src="'+ROOT+'/order-data/order-history/order-history-iframe.php?shopperId='+shopper+'&credentials='+credentials+'" width="370" height="350" frameborder="0" scrolling="no" ></iframe>');

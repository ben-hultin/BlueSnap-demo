...
$shopperId = $_REQUEST['shopper_id'];
 ...
 //please fill your api credential
	...
	https://BenPlimusAPI:BenPlimus789@sandbox.plimus.com/services/2/shoppers/19341670
     */
    ...
    //define('XML_GET_URL', 'https://sandbox.plimus.com/services/2/shoppers/'.$shopperId);
	define('XML_GET_URL', 'https://sandbox.plimus.com/services/2/tools/order-history-retriever?fullDescription=true&shopperid='.$shopperId);

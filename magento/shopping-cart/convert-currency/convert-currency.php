...
$url = 'https://'.$credentials.'@sandbox.plimus.com/services/1/tools/currency-convertor?from='.$from.'&to='.$to.'&amount='.$amount;
//https://ws.plimus.com/services/1/tools/currency-convertor?from=USD&to=EUR&amount=306
